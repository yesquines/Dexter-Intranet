...
<title>Dexter Courier | <?php echo gethostname(); echo ' | '.$_SERVER['SERVER_ADDR']; ?></title>
...
<body>
	<div id="grid_header">	
		<div id="top">		
			<div id="logo">			
				<a href="index.php" title="Dexter Courier"><img src="images/logo.png" alt="Curso e Consultoria Linux" /></a>
			</div>
		...
		<div id="title">
			<div class="title_text">
				<h1>Hostname: <?php echo gethostname(); ?><br />
				<i><?php echo $_SERVER['SERVER_ADDR']; ?></i>
				</h1>
			</div>
		</div>
	</div>
